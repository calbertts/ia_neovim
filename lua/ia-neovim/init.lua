...
function ia_neovim.AzureFunctionCall()
  ...
  local azure_function_url = 'https://proxytestcc.azurewebsites.net/api/HttpTrigger1'
  local azure_function_key = 'QFLCma9zyIb_WwqHCGRdJ1xM3iHOmoblZE22F7YteTc_AzFuSggYdw%3D%3D'  -- If your function needs an API key
